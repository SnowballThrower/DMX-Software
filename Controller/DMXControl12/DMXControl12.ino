...
void setupNames() {
  ...
  deviceStart[12] = 125 - 1; //Bar
  deviceStart[13] = 125 + maxCh - 1; //Bar
  deviceStart[14] = 150 - 1; //Bar
  deviceStart[15] = 150 + maxCh - 1; //Bar
  deviceStart[16] = 175 - 1; //Bar
  deviceStart[17] = 175 + maxCh - 1; //Bar
